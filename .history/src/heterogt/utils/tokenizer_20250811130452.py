...
class EHRTokenizer(object):
    def __init__(self, type_sentences, adm_index_sentences, age_gender_sentences, task_sentences, diag_sentences, med_sentences, lab_sentences, pro_sentences, special_tokens):
