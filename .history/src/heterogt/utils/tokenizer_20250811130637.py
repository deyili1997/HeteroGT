...
class EHRTokenizer(object):
    def __init__(self, type_sentences, adm_index_sentences, age_gender_sentences, task_sentences, 
        ...
        self.adm_index_voc = Voc() # adm_index vocabulary, not part of the global vocab, it is just for embedding adm_index information and add to the input
        ...
        self.adm_index_voc.add_sentence(adm_index_sentences)
